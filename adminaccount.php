    ...
    <form action="" method="post">
      <table width="100%" border="1" cellspacing="0" cellpadding="0">
        ...
        <?php $ords = explode(":",$key); ?>
            <tr>
                <td align="center" valign="middle" style="font-weight:bold;">Order Reference Number :: <?php print $ords[0]; ?> || Order Status :: <?php $ords[1] == 0 ? print "Order In Progress" : print "Shipped"; ?> <?php if($ords[1] == 0) { ?><a href="adminaccount.php?opr=y&oid=<?php print $ords[0]; ?>">Confirm</a> <?php } ?></td>
            </tr>
            <tr>
                <td>
                    <table width="100%" border="1" cellspacing="0" cellpadding="0">
