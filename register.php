  ...
  <tr>
    ...
    <form action="" method="post">
      <table width="100%" border="1" cellspacing="0" cellpadding="0">
        ...
        <tr>
          <td align="left" valign="middle" style="padding:0 0 0 10px;">Confirm Password</td>
          <td align="left" valign="middle"><input type="password" name="txtconpassword" id="txtconpassword" /></td>
        </tr>
        <tr>
          <td align="left" valign="middle" style="padding:0 0 0 10px;">&nbsp;</td>
          <td align="left" valign="middle"><input type="submit" name="btnRegister" id="btnRegister" value="Submit" /></td>
        </tr>
      </table>
    </form>
    </td>
